...
* Registrierung bei Discord. Siehe [Aufruf und Anmeldung bei Discord](/docs/communication/discord#aufruf-und-anmeldung). Wenn das nicht durchgeführt wurde, dann kann der Workshop trotzdem durchgeführt werden, Übungen mit Discord sind dann eben nicht möglich, werden vermutlich aber auch so nicht durchgeführt werden.
...
Beim ersten Aufruf von Discord wird man aufgefordert, sich zu registrieren. Siehe das Kapitel [Aufruf und Anmeldung bei Discord](/docs/communication/discord#aufruf-und-anmeldung).
