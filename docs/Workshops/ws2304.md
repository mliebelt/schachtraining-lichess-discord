...
* Registrierung bei Discord. Siehe [Aufruf und Anmeldung bei Discord](../communication/discord#aufruf-und-anmeldung). Wenn das nicht durchgeführt wurde, dann kann der Workshop trotzdem durchgeführt werden, Übungen mit Discord sind dann eben nicht möglich.
