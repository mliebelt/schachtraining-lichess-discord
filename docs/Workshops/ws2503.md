...
* Registrierung bei Discord (optional). Siehe [Aufruf und Anmeldung bei Discord](/docs/communication/discord#aufruf-und-anmeldung). Wenn das nicht durchgeführt wurde, dann kann der Workshop trotzdem durchgeführt werden, Übungen mit Discord werden nicht durchgeführt werden.
...
Siehe [Aufruf und Anmeldung bei Discord](/docs/communication/discord#aufruf-und-anmeldung) für den genauen Ablauf.

#### Anmeldung bei Discord

Passiert implizit beim Öffnen, man kann Discord nicht anonym nutzen.
Beim ersten Aufruf von Discord wird man aufgefordert, sich zu registrieren. Siehe das Kapitel [Aufruf und Anmeldung bei Discord](../communication/discord#aufruf-und-anmeldung).
...
Siehe das Kapitel [Aufbau von Discord](/docs/communication/discord#aufbau-von-discord) zu allen relevanten Aspekten.
...
Details zu den Text-Kanälen und Sprach-Kanälen sind dann im [Discord-Kapitel](/docs/communication/discord) in den Abschnitten [Bereitstellung von Text- und Sprachkanälen](/docs/communication/discord#text--und-sprachkanäle-bereitstellen), [Nutzung Textkanäle](/docs/communication/discord#nutzung-von-textkanälen) und [Nutzung von Sprachkanälen](/docs/communication/discord#nutzung-von-sprachkanälen) dargestellt.
