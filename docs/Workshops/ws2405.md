...
* Registrierung bei Discord. Siehe [Aufruf und Anmeldung bei Discord](../communication/discord#aufruf-und-anmeldung). Wenn das nicht durchgeführt wurde, dann kann der Workshop trotzdem durchgeführt werden, Übungen mit Discord sind dann eben nicht möglich, werden vermutlich aber auch so nicht durchgeführt werden.
...
Siehe [Aufruf und Anmeldung bei Discord](../communication/discord#aufruf-und-anmeldung) für den genauen Ablauf.
...
Siehe das Kapitel [Aufbau von Discord](../communication/discord#aufbau-von-discord) zu allen relevanten Aspekten.
...
Details zu den Text-Kanälen und Sprach-Kanälen sind dann im [Discord-Kapitel](../communication/discord) in den Abschnitten [Bereitstellung von Text- und Sprachkanälen](../communication/discord#text--und-sprachkanäle-bereitstellen), [Nutzung Textkanäle](../communication/discord#nutzung-von-textkanälen) und [Nutzung von Sprachkanälen](../communication/discord#nutzung-von-sprachkanälen) dargestellt.
