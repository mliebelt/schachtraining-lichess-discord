---
sidebar_position: 1
title: Workshop am 28.11.2025
---
# Workshop "Online-Training mit Lichess"

Diese Datei enthält die Übersicht über den Workshop, der am 28. November 2025 mit dem Thema "Wie macht man ein (reines) Online-Training?" durchgeführt werden wird. Teilnehmer haben damit später noch die Möglichkeit, auf die Workshop-Inhalte zuzugreifen. Der Workshop findet vor Ort statt, und ist deshalb ein wenig anders strukturiert.

* [Für die Teilnehmer](#für-die-teilnehmer)
* [Übersicht Lichess und Jitsi](#übersicht-lichess-und-jitsi)
	...
	* [Aufruf von Jitsi](#aufruf-von-jitsi)
	* [Weitere Bestandteile](#weitere-bestandteile)
* [Installation Software für Lichess und Jitsi](#installation-software-für-lichess-und-jitsi)
* [Nutzung von Jitsi im Training](#nutzung-von-jitsi-im-training)
* [Nutzung von Lichess im Training](#nutzung-von-lichess-im-training)
* [Trainingsszenarien für Lichess und Jitsi](#trainingsszenarien-für-lichess-und-jitsi)
* [Übungen](#übungen)
...
Lichess und Jitsi sind zwei getrennte Anwendungen, die nichts miteinander zu tun haben. Von daher werden sie separat dargestellt, hier nur ein Überblick. Wichtig: Man hat die besten Ergebnisse, wenn beide im Browser laufen. Man sollte also gewohnt sein, die Tabs im Browser zu wechseln.
...
* Jeder Teilnehmer benötigt ein **Mikrofon** und **Lautsprecher**. Meist wird in **Headset** verwendet, ich verwende manchmal ein externes Mikro, teils In-Ear-Kopfhörer mit Mikrofon, manche **Webcams** haben auch ein Mikrofon integriert, oder der Laptop selbst hat ein eingebautes Mikrofon. Der **Lautsprecher des Rechners** genügt im Regelfall, man kann aber auch mit einem externen Lautsprecher arbeiten, oder eben mit einem Headset. Man sollte die verschiedenen Möglichkeiten ausprobieren, und auch gewandt sein, von einer zur anderen zu wechseln, um die beste Qualität zu erreichen.
...
## Installation Software für Lichess und Jitsi
...
Jitsi ist ebenfalls eine Anwendung im Browser. Es gibt auf den verschiedenen Plattformen unterschiedliche Versionen, ich habe wenig Erfahrung damit. Jitsi kann auch direkt im Browser genutzt werden, die Unterschiede sind meist marginal. Ich war bisher mit Jitsi im Browser sehr zufrieden. Wenn man Jitsi als Anwendung startet, dann kann man Lichess und Jitsi besser voneinander trennen.
...
## Trainingsszenarien für Lichess und Jitsi
...
* Admin (vereinfachend für lichess und Jitsi): Administriert die serverseitigen Dinge in den Systemen.
...
| Jitsi-Einladung | Einladung an Trainer und Teilnehmer schicken | X | | |
...
* Lichess Account
* Anmeldung im Team des Workshops (Lichess), kann auch während des Workshops erfolgen
